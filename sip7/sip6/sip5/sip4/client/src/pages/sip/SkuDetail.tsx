        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Product Description for {skuId}</p>
            </div>
          </div>
        </div>
                  ...
                  <table className="w-full border-collapse">
                    <thead className="sticky top-0 z-10">
                      <tr>
                        ...
                        <TableHeader className="w-[110px]">Presentation Stock</TableHeader>
                              ...
                              <td colSpan={8} className="p-0 bg-slate-50/30">
                                <div className="p-4 pl-12 space-y-3">
                                  <div className="flex items-center gap-6 py-2 px-3 bg-white rounded border border-slate-200">
                                    ...
                                    <div className="flex items-center gap-2">
                                      <span className="text-[10px] font-medium text-slate-500 uppercase">Presentation Stock</span>
                                      <Input 
                                        defaultValue={row.presentation} 
